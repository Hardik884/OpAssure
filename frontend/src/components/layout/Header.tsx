    ...
    <header className="sticky top-0 z-30 border-b border-white/10 bg-ink-950 text-white">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-3 px-4 sm:px-6">
        <div className="flex min-w-0 items-center gap-2.5">
          <span className="shrink-0 rounded-industrial bg-brand-500 px-2 py-1 font-display text-sm font-semibold tracking-tight text-ink-950">
            OP
          </span>
          <span className="truncate font-display text-lg font-semibold tracking-tight">OpAssure</span>
        </div>
